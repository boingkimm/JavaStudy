...
public class StringTest2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("3. 특정 문자 위치:" + s.indexOf('r'));  //없으면 -1
		
		System.out.println("4. 대문자:" + s.toUpperCase());
		System.out.println("5. 소문자:" + s.toLowerCase());
		
		System.out.println("6. 문자열 연결:" + s.concat(" ~~~")); //연산자
		System.out.println("6. 문자열 연결:" + s + " ~~~");  //문자열
		...
		System.out.println("8. 문자열 포함여부:" + s.contains("f"));
		...
		System.out.println("10. 문자열 비교(대소문자무시):" + s.equalsIgnoreCase("hellO"));
		
		String s2 = "     world     ";
		System.out.println("11. 공백제거:" + s2.trim());  //양쪽 공백 제거
		System.out.println("11. 공백제거:" + s2.trim().length());  //공백제거한 길이
		
		// 구분자로 분리 ==> 배열로 반환
		String s3 = "AAA/BBB/CCC";
		String [] arr = s3.split("/");
		System.out.println("12. 구분자로 분리:" + Arrays.toString(arr));  //배열을 문자열로 반환
		
		//--------------------------------------------------------------
		// String의 static메서드 (String.~~)
		...
		System.out.println("14. 문자열로 변경:" + String.valueOf(new char[] {'A','B'})); //배열정의하는 세번째 방법 //배열을 문자열로 변경
		
		// 원본 문자열 ==> String문자열은 변경되지 않는다. 새로운 문자열이 생성된 것이다.(14+개)
		System.out.println(s);   //HeLLo 원본 변경없이 그대로 있음!
