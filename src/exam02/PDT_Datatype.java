...
public class PDT_Datatype {
	...
	public static void main(String[] args) {
		...
		System.out.println(01);   //8진수  01 ~ 07
		System.out.println(07);   //8진수
		
		System.out.println(0x0);  //16진수 0x0 ~ 0x9 (10개)
		System.out.println(0xA);  //16진수 0xA ~ 0xF (6개)
		...
		System.out.println(3.14F);  //float으로 처리
		System.out.println(3.14f);  //float으로 처리
